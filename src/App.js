...
const withSlider = (BaseComponent, getData) => {
    return (props) => {
        ...
        return <BaseComponent
                ...
                setAutoplay={setAutoplay}></BaseComponent>
    }
}
...
const SliderWithSecondtFetch = withSlider(SliderSecond, getDataFromSecondFetch);
...
function App() {
    return (
        <>
            ...
            <SliderWithSecondtFetch></SliderWithSecondtFetch>
        </>
    );
}
